...
import static org.sellcom.geotemporal.internal.time.GeoTemporalPredicateUtils.testGeoTemporalPredicate;
...
import static org.sellcom.geotemporal.time.applicability.GeoTemporalApplicability.parse;
...
public class TemporalApplicabilityTest_parse {

	@Test
	public void testParse_dateRange_notSame() {
		GeoTemporalApplicability applicability = parse("dateRange[2012-07-27,2012-08-12]"); // Official dates of 2012 Summer Olympics in London

		testGeoTemporalPredicate(applicability,
	...
	@Test
	public void testParse_dateRange_same() {
		GeoTemporalApplicability applicability = parse("dateRange[2005-07-06,2005-07-06]"); // London selected as the host city of 2012 Summer Olympics
	...
	@Test
	public void testParse_dayOfWeekAfter() {
		GeoTemporalApplicability applicability = parse("dayOfWeekAfter[4,Thu,10-31]"); // Thanksgiving Day in the United States
	...
	@Test
	public void testParse_dayOfWeekBefore() {
		GeoTemporalApplicability applicability = parse("dayOfWeekBefore[2,Sun,12-25]"); // Gaudete Sunday
	...
	@Test
	public void testParse_dayOfWeekRange_coveringWholeRange() {
		GeoTemporalApplicability applicability = parse("dayOfWeekRange[Mon,Sun]"); // Whole week (start on Monday as in Europe)
	...
	@Test
	public void testParse_dayOfWeekRange_notWrappingAroundTheEndOfTheWeek() {
		GeoTemporalApplicability applicability = parse("dayOfWeekRange[Fri,Sat]"); // Weekend in Israel
	...
	@Test
	public void testParse_dayOfWeekRange_same() {
		GeoTemporalApplicability applicability = parse("dayOfWeekRange[Sat,Sat]"); // End of Jewish Sabbath
	...
	@Test
	public void testParse_dayOfWeekRange_wrappingAroundTheEndOfTheWeek() {
		GeoTemporalApplicability applicability = parse("dayOfWeekRange[Sun,Thu]"); // Workweek in Israel
	...
	@Test
	public void testParse_evenIsoWeek() {
		GeoTemporalApplicability applicability = parse("isoWeek[even]");
	...
	public void testIsoWeekRange_coveringWholeRange() {
		GeoTemporalApplicability applicability = parse("isoWeekRange[1,53]");
	...
	public void testIsoWeekRange_notWrappingAroundTheEndOfTheYear() {
		GeoTemporalApplicability applicability = parse("isoWeekRange[7,8]");
	...
	public void testIsoWeekRange_same() {
		GeoTemporalApplicability applicability = parse("isoWeekRange[7,7]");
	...
	public void testIsoWeekRange_wrappingAroundTheEndOfTheYear() {
		GeoTemporalApplicability applicability = parse("isoWeekRange[51,2]");
	...
	@Test
	public void testParse_monthDayRange_coveringWholeRange() {
		GeoTemporalApplicability applicability = parse("monthDayRange[09-01,08-31]"); // Official school year in the Czech Republic
	...
	@Test
	public void testParse_monthDayRange_notWrappingAroundTheEndOfTheYear() {
		GeoTemporalApplicability applicability = parse("monthDayRange[12-24,12-26]"); // Christmas-related public holidays in the Czech Republic
	...
	@Test
	public void testParse_monthDayRange_same() {
		GeoTemporalApplicability applicability = parse("monthDayRange[01-01,01-01]"); // New Year's Day
	...
	@Test
	public void testParse_monthDayRange_wrappingAroundTheEndOfTheYear() {
		GeoTemporalApplicability applicability = parse("monthDayRange[12-31,01-01]"); // New Year's Eve and New Year's Day
	...
	@Test
	public void testParse_monthRange_coveringWholeRange() {
		GeoTemporalApplicability applicability = parse("monthRange[01,12]"); // Calendar year
	...
	@Test
	public void testParse_monthRange_notWrappingAroundTheEndOfTheYear() {
		GeoTemporalApplicability applicability = parse("monthRange[06,07]"); // The Championships in Wimbledon takes place
	...
	@Test
	public void testParse_monthRange_same() {
		GeoTemporalApplicability applicability = parse("monthRange[06,06]"); // Glastonbury Festival takes place
	...
	@Test
	public void testParse_monthRange_wrappingAroundTheEndOfTheYear() {
		GeoTemporalApplicability applicability = parse("monthRange[08,05]"); // Premier League season
	...
	@Test
	public void testParse_oddIsoWeek() {
		GeoTemporalApplicability applicability = parse("isoWeek[odd]");
	...
	@Test
	public void testParse_singleDate() {
		GeoTemporalApplicability applicability = parse("singleDate[1863-01-10]"); // London Underground began operation
	...
	@Test
	public void testParse_singleDayOfWeek() {
		GeoTemporalApplicability applicability = parse("singleDayOfWeek[Fri]"); // Begin of Jewish Sabbath
	...
	@Test
	public void testParse_singleIsoWeek() {
		GeoTemporalApplicability applicability = parse("singleIsoWeek[1]");
	...
	@Test
	public void testParse_singleMonth() {
		GeoTemporalApplicability applicability = parse("singleMonth[04]"); // London Marathon takes place
	...
	@Test
	public void testParse_singleMonthDay() {
		GeoTemporalApplicability applicability = parse("singleMonthDay[04-23]"); // St George's Day (Patron saint of England)
	...
	@Test
	public void testParse_singleYear() {
		GeoTemporalApplicability applicability = parse("singleYear[2000]"); // Formation of Transport for London
	...
	@Test
	public void testParse_yearRange_notSame() {
		GeoTemporalApplicability applicability = parse("yearRange[1851,1852]"); // Construction of London King's Cross railway station
	...
	@Test
	public void testParse_yearRange_same() {
		GeoTemporalApplicability applicability = parse("yearRange[1852,1852]"); // Official opening of London King's Cross railway station
