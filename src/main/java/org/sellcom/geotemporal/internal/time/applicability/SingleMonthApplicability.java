...
public final class SingleMonthApplicability extends TemporalApplicability {

	private final Month month;


	public SingleMonthApplicability(Month month) {
	...
	public boolean test(Temporal temporal) {
		...
		return month.equals(Month.from(temporal));
	}
