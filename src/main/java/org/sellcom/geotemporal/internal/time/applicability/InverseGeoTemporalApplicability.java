...
public class InverseGeoTemporalApplicability extends GeoTemporalApplicability {

	private final GeoTemporalApplicability applicability;


	public InverseGeoTemporalApplicability(GeoTemporalApplicability applicability) {
	...
	public boolean test(Temporal temporal, GeoRegion region) {
		...
		return !applicability.test(temporal, region);
	}
